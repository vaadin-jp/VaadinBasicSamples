import { n as sn, r as ve, p as Le, M as Mt, q as M, u as O, O as Oi, A as Xt, v as oo, E as Oe, w as Wt, e as ee, x as C, y as ao, c as X, z as so, D as ln, f as Ai, F as Pe, G as se, H as lo, I as co, J as Pi, K as uo, L as ho, N as ze, Q as fo, R as K, S as cn, T as po, U as mo, V as Te, W as Nt, X as Ht, Y as In, Z as go, _ as vo, $ as bo, a0 as ct, a1 as Fe, a2 as dn, C as Yt, a3 as Eo, a4 as yo, a5 as wo, a6 as Ro, a7 as Io, a8 as So, P as $o } from "./copilot-D30x30KI.js";
import { c as rt, a as _i } from "./repeat-CKwNAvQ3.js";
import { L as To } from "./lit-renderer-I_UEoOuA.js";
/**
 * @license
...
$.prototype = /** @lends Sortable.prototype */
{
  ...
  _onDragOver: function(e) {
    ...
    if (g.contains(e.target) || n.animated && n.animatingX && n.animatingY || b._ignoreWhileAnimating === n)
      return k(!1);
    if (Ot = !1, s && !d.disabled && (l ? u || (a = U !== j) : Q === this || (this.lastPutMode = mt.checkPull(this, s, g, e)) && c.checkPut(this, s, g, e))) {
  ...
  render() {
    ...
    return C`
      ...
      <div class="flex" id="common-mode-panel-icon-container">
        ...
        <vaadin-popover
          @opened-changed="${(e) => {
      this.expandModeHandler.devToolsPopoverOpenClosedChanged(e.detail.value), e.detail.value && !this.devToolsDataLoaded && (this.devToolsDataLoading = !0, import("./copilot-devtools-DR0BYj25.js").then(() => {
...
function Ee() {
  ...
  class e {
    ...
    parseRange(m) {
      ...
      m = m.replace(D, Ie(this.options.includePrerelease)), a("hyphen replace", m), m = m.replace(c[s.COMPARATORTRIM], l), a("comparator trim", m), m = m.replace(c[s.TILDETRIM], u), a("tilde trim", m), m = m.replace(c[s.CARETTRIM], h), a("caret trim", m);
  ...
  }, Re = (v, m) => (a("replaceStars", v, m), v.trim().replace(c[s.STAR], "")), he = (v, m) => (a("replaceGTE0", v, m), v.trim().replace(c[m.includePrerelease ? s.GTE0PRE : s.GTE0], "")), Ie = (v) => (m, y, E, R, w, D, F, P, B, re, W, Ke) => (A(E) ? y = "" : A(R) ? y = `>=${E}.0.0${v ? "-0" : ""}` : A(w) ? y = `>=${E}.${R}.0${v ? "-0" : ""}` : D ? y = `>=${y}` : y = `>=${y}${v ? "-0" : ""}`, A(B) ? P = "" : A(re) ? P = `<${+B + 1}.0.0-0` : A(W) ? P = `<${B}.${+re + 1}.0-0` : Ke ? P = `<=${B}.${re}.${W}-${Ke}` : v ? P = `<${B}.${re}.${+W + 1}-0` : P = `<=${P}`, `${y} ${P}`.trim()), ce = (v, m, y) => {
...
function is() {
  if (Ci) return Yr;
  Ci = 1;
  const t = ft(), e = Bt(), r = oe(), n = to(), i = Je(), o = La(), a = Ma(), d = Na(), c = Ha(), s = ka(), l = Fa(), u = Va(), h = qa(), p = be(), b = Ba(), f = ja(), I = bn(), _ = Za(), k = Ga(), A = Zt(), V = En(), G = ro(), N = no(), q = yn(), T = wn(), J = io(), Re = Ua(), he = Gt(), Ie = Ee(), ce = Ut(), v = Wa(), m = Ya(), y = za(), E = Ja(), R = Ka(), w = Rn(), D = Qa(), F = es(), P = ts(), B = rs(), re = ns();
  return Yr = {
    parse: i,
    valid: o,
    clean: a,
...
as.on("serverInfo", (t) => {
  ...
  Ai(`${$o}get-release-note-url`, { version: i }, (o) => {
    ...
    if (!a.error && a.url)
      if (n) {
        const d = Di(i), c = Di(n), s = d !== null && c !== null ? lt.gte(d, c) : i === n;
